...
const ProjectsSection = () => {
  ...
  const minis = projects.slice(3, 7);
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            {!isLoading &&
              minis.map((p) => (
                <div
                  key={p._id}
                  className="glass-card p-6 hover:-translate-y-1 hover:border-accent/40 hover:shadow-[0_10px_30px_-10px_rgba(45,212,191,0.2)] transition-all duration-300 group cursor-pointer"
                >
                  <div className="flex items-center justify-between mb-4">
